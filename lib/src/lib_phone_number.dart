...
class PhoneNumberUtil {
  ...
  static Future<CountryInfo?> getInfoSim() async {
    Map<dynamic, dynamic> result = await _channel.invokeMethod('getInfoSim');

    return CountryInfo(
        simIso: result['simCountryIso'],
        simCountryIso: result['simNetworkIso']);
  }
